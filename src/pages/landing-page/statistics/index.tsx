    ...
    <section className={s.root}>
      <ul className={s.list}>
        ...
        <li className={cn("container-padding flex flex-col")}>
          ...
          <a href={'https://edusogno.com/form/edusogno-inglese' + window.location.search} className="btn-green btn-sm w-[265px] uppercase py-6 mx-auto my-6 xl:my-10 flex text-xl font-semibold justify-center items-center">
            {/* RICHIEDI INFO */}
            {t('form.buttonInfo')}
          </a>
          {/* </div> */}
